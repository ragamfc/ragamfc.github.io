  ...
  return (
    <>
      <section className="w-full text-white">
        <div className="relative z-[10] h-screen bg-cover bg-no-repeat bg-[url('/images/dominik-kuhn-kEHp1gUJNO8-unsplash.webp')] bg-[#d01144] bg-blend-multiply">
          ...
          <div className="absolute z-[40] top-10 w-full space-y-4 px-8 sm:top-24 xl:px-36">
            ...
            <div className="space-y-4">
              ...
              <div className="max-w-[480px] text-base font-bold">
